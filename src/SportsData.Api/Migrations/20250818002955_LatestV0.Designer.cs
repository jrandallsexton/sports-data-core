...
namespace SportsData.Api.Migrations
{
    ...
    [Migration("20250818002955_LatestV0")]
    partial class LatestV0
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SportsData.Api.Infrastructure.Data.Entities.PickemGroupMatchup", b =>
                {
                    ...
                    b.HasIndex("GroupId", "SeasonWeekId");
            ...
            modelBuilder.Entity("SportsData.Api.Infrastructure.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedUtc = new DateTime(2025, 8, 18, 0, 29, 55, 526, DateTimeKind.Utc).AddTicks(7865),
                            DisplayName = "Foo Bar",
                            Email = "foo@bar.com",
                            EmailVerified = true,
                            ...
                            IsSynthetic = false,
                            LastLoginUtc = new DateTime(2025, 8, 18, 0, 29, 55, 526, DateTimeKind.Utc).AddTicks(8009),
