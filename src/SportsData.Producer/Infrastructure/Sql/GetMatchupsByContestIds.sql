SELECT
  ...
  fAway."DisplayName" AS "Away", fAway."Abbreviation" AS "AwayShort", fAway."DisplayNameShort" AS "AwayShortName",
  ...
  fHome."DisplayName" AS "Home", fHome."Abbreviation" AS "HomeShort", fHome."DisplayNameShort" AS "HomeShortName",
