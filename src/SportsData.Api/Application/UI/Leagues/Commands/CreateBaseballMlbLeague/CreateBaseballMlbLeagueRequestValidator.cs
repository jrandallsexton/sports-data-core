...
public class CreateBaseballMlbLeagueRequestValidator : AbstractValidator<CreateBaseballMlbLeagueRequest>
{
    public CreateBaseballMlbLeagueRequestValidator()
    {
        ...
        RuleFor(x => x)
            ...
            .WithName(nameof(CreateBaseballMlbLeagueRequest.EndsOn))
