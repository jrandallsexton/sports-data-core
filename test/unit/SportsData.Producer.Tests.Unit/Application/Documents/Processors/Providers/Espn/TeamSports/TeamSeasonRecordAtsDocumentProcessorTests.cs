...
public class TeamSeasonRecordAtsDocumentProcessorTests : ProducerTestBase<TeamSeasonRecordAtsDocumentProcessor<TeamSportDataContext>>
{
    [Fact]
    public async Task NotYetImplemented_Fails()
    {
        await Task.Delay(100);
        Assert.Fail("Test not yet implemented for TeamSeasonRecordAtsDocumentProcessor");
    }
}
