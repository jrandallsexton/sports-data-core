# sportDeets — App Icon & Brand Mark

Italic bold **S** knocked out of a capital **D**, centered in the bowl,
...
- `ios/` — full iOS size ladder (20–180px)
- `expo/` — icon, splash-icon, adaptive-icon-foreground/background, android-icon
- `favicon/` — favicon.ico (multi-res) + PNGs + site-head.html
- `variants/` — inverted cyan tile, white mono, transparent mark
