...
WHERE "Uri" LIKE '%sportdeetssadev.blob.core.windows.net/prod-provider-footballncaa-athleteimage%';
...
SELECT 
    ...
    "Uri" as old_uri,
    REPLACE("Uri", 
        'sportdeetssadev.blob.core.windows.net/prod-provider-footballncaa-athleteimage',
