...
namespace SportsData.Core.Common
{
    public static class CausationId
    {
        public static class Api
        {
            ...
            public static readonly Guid PreviewApproval = new Guid("10000000-3000-0000-0000-000000000002");
        ...
        public static class Producer
        {
            ...
            public static Guid TeamSeasonLeadersDocumentProcessor = new Guid("10000000-0000-0000-0000-000000000050");  
            ...
            public static Guid EventCompetitionDriveDocumentProcessor = new Guid("10000300-0000-0000-0000-00000000001E");
