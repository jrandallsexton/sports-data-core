...
{
    public class EspnFootballCalendarOndaysDetailDto : IHasRoutingKey
    {
        ...
        public string RoutingKey { get; } = "espn.v2.sports.football.leagues.college-football.calendar.ondays.detail";
