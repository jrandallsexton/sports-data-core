...
namespace SportsData.Core.Common
{
    public static class CausationId
    {
        public static class Producer
        {
            ...
            public static Guid AthleteSeasonDocumentProcessor = new Guid("10020000-0000-0000-0000-000000000001");
            ...
            public static Guid EventDocumentProcessor = new Guid("10000000-0000-0000-0000-00000000000C");
            public static Guid EventCompetitionDocumentProcessor = new Guid("10000000-0000-0000-0000-00000000000D");
            public static Guid EventCompetitionLeadersDocumentProcessor = new Guid("10000000-0000-0000-0000-00000000000E");
            public static Guid EventCompetitionPowerIndexDocumentProcessor = new Guid("10000000-1000-0000-0000-00000000000E");
            public static Guid EventCompetitionStatusDocumentProcessor = new Guid("10002000-1000-0000-0000-00000000000E");
        }
