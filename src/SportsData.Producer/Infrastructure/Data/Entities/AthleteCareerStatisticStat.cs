...
public class AthleteCareerStatisticStat : CanonicalEntityBase<Guid>
{
    public Guid AthleteCareerStatisticCategoryId { get; set; }

    public AthleteCareerStatisticCategory Category { get; set; } = null!;
    ...
    public class EntityConfiguration : IEntityTypeConfiguration<AthleteCareerStatisticStat>
    {
        public void Configure(EntityTypeBuilder<AthleteCareerStatisticStat> builder)
        {
            builder.ToTable(nameof(AthleteCareerStatisticStat));
