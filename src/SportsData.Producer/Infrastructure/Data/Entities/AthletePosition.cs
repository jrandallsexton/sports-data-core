...
namespace SportsData.Producer.Infrastructure.Data.Entities
{
    public class AthletePosition : CanonicalEntityBase<Guid>, IHasExternalIds
    {
        ...
        public ICollection<AthletePosition> Children { get; set; } = [];

        public ICollection<AthletePositionExternalId> ExternalIds { get; set; } = [];
        ...
        public class EntityConfiguration : IEntityTypeConfiguration<AthletePosition>
        {
            ...
            {
                builder.ToTable(nameof(AthletePosition));
