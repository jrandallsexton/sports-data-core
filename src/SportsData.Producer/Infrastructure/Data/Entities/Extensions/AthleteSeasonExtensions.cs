...
{
    public static BaseballAthleteSeason AsBaseballEntity(
        this EspnBaseballAthleteSeasonDto dto,
    ...
    {
        if (dto.Ref is null)
            throw new ArgumentException("Missing $ref on EspnBaseballAthleteSeasonDto");

        var identity = externalRefIdentityGenerator.Generate(dto.Ref);

        return new BaseballAthleteSeason
        {
