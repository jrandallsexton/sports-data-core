...
public static class CompetitionDriveExtensions
{
        ...
        Guid? endFranchiseSeasonId = null)
    {
        ...
        return new CompetitionDrive
        {
            ...
            Description = string.IsNullOrEmpty(dto.Description) ? CompetitionDriveConstants.UnknownDescription : dto.Description,
            ...
            Result = dto.Result,
            SequenceNumber = dto.SequenceNumber ?? CompetitionDriveConstants.UnknownSequence,
