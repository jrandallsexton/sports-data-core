        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProcessingInstanceId = table.Column<Guid>(type: "uuid", nullable: true),
                    ProcessingStartedUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CronExpression = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
