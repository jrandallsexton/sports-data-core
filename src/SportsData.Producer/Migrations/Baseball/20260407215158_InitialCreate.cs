    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AthleteSeasonHotZone", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "AthleteSeasonHotZoneEntry",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    AthleteSeasonHotZoneId = table.Column<Guid>(type: "uuid", nullable: false),
                    ZoneId = table.Column<int>(type: "integer", nullable: false),
                    XMin = table.Column<double>(type: "double precision", precision: 7, scale: 2, nullable: false),
                    XMax = table.Column<double>(type: "double precision", precision: 7, scale: 2, nullable: false),
                    YMin = table.Column<double>(type: "double precision", precision: 7, scale: 2, nullable: false),
                    YMax = table.Column<double>(type: "double precision", precision: 7, scale: 2, nullable: false),
                    AtBats = table.Column<int>(type: "integer", nullable: true),
                    Hits = table.Column<int>(type: "integer", nullable: true),
                    BattingAvg = table.Column<double>(type: "double precision", precision: 7, scale: 4, nullable: true),
                    BattingAvgScore = table.Column<double>(type: "double precision", precision: 7, scale: 4, nullable: true),
                    Slugging = table.Column<double>(type: "double precision", precision: 7, scale: 4, nullable: true),
                    SluggingScore = table.Column<double>(type: "double precision", precision: 7, scale: 4, nullable: true),
                    CreatedUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ModifiedUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CreatedBy = table.Column<Guid>(type: "uuid", nullable: false),
                    ModifiedBy = table.Column<Guid>(type: "uuid", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AthleteSeasonHotZoneEntry", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AthleteSeasonHotZoneEntry_AthleteSeasonHotZone_AthleteSeaso~",
                        column: x => x.AthleteSeasonHotZoneId,
                        principalTable: "AthleteSeasonHotZone",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DraftDisplayText = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    DraftRound = table.Column<int>(type: "integer", nullable: true),
                    DraftYear = table.Column<int>(type: "integer", nullable: true),
                    DraftSelection = table.Column<int>(type: "integer", nullable: true),
                    DraftTeamRef = table.Column<string>(type: "character varying(250)", maxLength: 250, nullable: true),
                    CollegeAthleteRef = table.Column<string>(type: "character varying(250)", maxLength: 250, nullable: true),
                    ...
                    BatsType = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    BatsAbbreviation = table.Column<string>(type: "character varying(5)", maxLength: 5, nullable: true),
                    ThrowsType = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    ThrowsAbbreviation = table.Column<string>(type: "character varying(5)", maxLength: 5, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AthleteSeasonHotZone_AthleteSeasonId_ConfigurationId_Season~",
                table: "AthleteSeasonHotZone",
                columns: new[] { "AthleteSeasonId", "ConfigurationId", "Season", "SeasonType" });

            migrationBuilder.CreateIndex(
                name: "IX_AthleteSeasonHotZoneEntry_AthleteSeasonHotZoneId",
                table: "AthleteSeasonHotZoneEntry",
                column: "AthleteSeasonHotZoneId");
